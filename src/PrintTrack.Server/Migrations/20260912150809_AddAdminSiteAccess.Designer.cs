...
namespace PrintTrack.Server.Migrations
{
    ...
    [Migration("20260912150809_AddAdminSiteAccess")]
    partial class AddAdminSiteAccess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrintTrack.Server.Data.AdminSiteAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AdminUserId", "SiteId")
                        .IsUnique();

                    b.ToTable("AdminSiteAccess");
                });
            ...
            modelBuilder.Entity("PrintTrack.Server.Data.AdminSiteAccess", b =>
                {
                    b.HasOne("PrintTrack.Server.Data.AdminUser", "AdminUser")
                        .WithMany()
